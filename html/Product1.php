...
<p><a href="Products.php">Getting start</a></p>
...
<article>
<h2 class="title">Search book by title, if you see the borrow button, you can borrow it.(or if others have borrowed it)</h2>
<p class="copy">
<?php
require('search.php');
?>
